...
Wrathful Smite*/
	...
	BLADE_WARD 	(	0, "Blade Ward",  Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
	CHILL_TOUCH (	0, "Chill Touch", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	0, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	0, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	0, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	0, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
...
//	ACID_SPLASH (	0, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	0, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	1, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	1, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	1, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	1, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
//	ACID_SPLASH (	1, "Acid Splash", Paths.ACID_SPLASH_HTML.getPath(), new HashSet<Classes>(Arrays.asList(Classes.SORCERER, Classes.WIZARD))),
